...
/* 햄버거버튼 탑 메뉴 클릭 시  */
const mobTad5 = document.querySelector(".mob>dl.mob_topMenu>dd:nth-of-type(5)");
const gnbLi2 = document.querySelector(".mob>nav.mob_gnb>ul>li:nth-child(2)");
const gnbLi3 = document.querySelector(".mob>nav.mob_gnb>ul>li:nth-child(3)");
const gnbLi5 = document.querySelector(".mob>nav.mob_gnb>ul>li:nth-child(5)");

mobTad5.addEventListener('click',e =>{
    e.preventDefault();
    e.currentTarget.classList.toggle("on");
...
gnbLi2.addEventListener('click',e =>{
    e.preventDefault();
    e.currentTarget.classList.toggle("on");
});
gnbLi3.addEventListener('click',e =>{
    e.preventDefault();
    e.currentTarget.classList.toggle("on");
});
gnbLi5.addEventListener('click',e =>{
    e.preventDefault();
    e.currentTarget.classList.toggle("on");
});
